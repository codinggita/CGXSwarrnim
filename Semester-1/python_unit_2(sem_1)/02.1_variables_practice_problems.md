...
```text
Answer: name = "Rahul"  -> value is Rahul
age = 18  -> value is 18
city = "Patna" -> value is Patna
...
Explain why.
Answer:The final value of age is 19.
Python runs the code from top to bottom:
age = 18 → age is set to 18.
age = 19 → the previous value is replaced with 19.
...
name = "Riya"
```
Answer: the final value of name is Riya.
### 21.
...
→ Stores the name Rahul in student_name.
student_age = 18
→ Stores 18 in student_age.
student_age = 19
→ Changes student_age from 18 to 19.
Final values:
student_name → "Rahul"
student_age → 19
The original value 18 is replaced by 19.
### 22.
