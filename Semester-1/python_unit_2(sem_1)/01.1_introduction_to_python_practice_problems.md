...
```python
# Display a message is a comment
print("Hello")
```
...
student_name = "Rahul"
Answer: The purpose of the comment is to explain that the variable student_name stores the student's name
```
...
Explain your answer.
Answer:student_name
student_name is easier to understand because it clearly tells us that the variable is used to store a student's name.
